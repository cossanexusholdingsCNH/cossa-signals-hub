-- COSSA SIGNALS — AUTO EXECUTION CONFIRMATION RULE
-- Runs after 20260918234500 so the `auto` enum value is committed before it is referenced.

-- Existing paper_auto rows remain valid for backwards compatibility.
-- New unified accounts/orders use `auto`; account_environment determines demo vs live.
--
