...
-- One deterministic engine evaluation per provider/instrument/timeframe/closed-candle boundary.
-- This blocks scheduler retries or duplicate workers from generating duplicate evidence.
